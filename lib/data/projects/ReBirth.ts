...
fun completePayment(token: String) {
    ...
    },
    {
      ...
      intent: '소비 리포트는 사용자가 자신의 상세한 소비 데이터를 직관적으로 확인할 수 있도록 만든 화면입니다. 가계부는 토스의 월별 소비 내역에서 많은 레퍼런스를 얻었습니다. 일반적인 리스트 형식 대신 캘린더를 사용함으로써 월간 소비를 좀 더 한눈에 볼 수 있도록 만들어봤습���다. 또한 소비 리포트를 통해 지금까지의 소비에 대한 인사이트를 제공하고자 했습니다.',
    }
  ],
