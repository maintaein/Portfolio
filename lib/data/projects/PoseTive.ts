...
export const poseTive: Project = {
  ...
  motivation: '대상만 있다면 포즈는 자유롭게 양산할 수 있도록 도와주는 모델. 웹툰이나 일러스트를 그릴 때 캐릭터의 포즈를 매번 처음부터 그리는 것은 손목에도, 시간에도 큰 부담입니다. 캐릭터는 이미 있으니 포즈만 간단히 스케치해서 붙이면 그 포즈대로 캐릭터가 움직여주면 어떨까라는 아이디어에서 출발했습니다.',
  implementations: [
    {
      category: '모델 파인튜닝',
